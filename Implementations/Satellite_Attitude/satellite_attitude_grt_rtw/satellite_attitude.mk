...
## Generated on : Tue Mar 18 20:02:47 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/satellite_attitude.exe
...
START_DIR                 = C:/Users/sebas/OneDrive/Dokumenty/MATLAB
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = satellite_attitude_comp.rsp
CMD_FILE                  = satellite_attitude.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/satellite_attitude.exe
...
DEFINES_STANDARD = -DMODEL=satellite_attitude -DNUMST=1 -DNCSTATES=7 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/satellite_attitude_grt_rtw/rt_nonfinite.cpp $(START_DIR)/satellite_attitude_grt_rtw/satellite_attitude.cpp $(START_DIR)/satellite_attitude_grt_rtw/satellite_attitude_data.cpp
...
OBJS = rt_logging.obj rt_nonfinite.obj satellite_attitude.obj satellite_attitude_data.obj
...
%.obj : $(START_DIR)/satellite_attitude_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/satellite_attitude_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/satellite_attitude_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/satellite_attitude_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/satellite_attitude_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_nonfinite.obj : $(START_DIR)/satellite_attitude_grt_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


satellite_attitude.obj : $(START_DIR)/satellite_attitude_grt_rtw/satellite_attitude.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


satellite_attitude_data.obj : $(START_DIR)/satellite_attitude_grt_rtw/satellite_attitude_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
