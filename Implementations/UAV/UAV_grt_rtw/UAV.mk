...
## Modified on  : Thu Apr 03 15:00:00 2025 (Souren)
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/UAV
...
START_DIR				  = /mnt/c/Users/soure/Desktop/Uni\ Sachen/CT-Verification/Implementations/UAV
...
DIVINE_PATH 			  = /mnt/c/Users/soure/Programs/divine-4.4.2/
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/UAV
PRODUCT-DIV = $(RELATIVE_PATH_TO_ANCHOR)/UAV.bc
...
DEFINES_STANDARD = -DMODEL=UAV -DNUMST=2 -DNCSTATES=10 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c \
...
OBJS = rt_logging.o UAV.o UAV_data.o rt_nonfinite.o Observer.o ConcreteObserverStates.o
...
%.o : $(START_DIR)/UAV_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/UAV_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
UAV.o : $(START_DIR)/UAV_grt_rtw/UAV.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


UAV_data.o : $(START_DIR)/UAV_grt_rtw/UAV_data.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"

rt_nonfinite.o : $(START_DIR)/UAV_grt_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
